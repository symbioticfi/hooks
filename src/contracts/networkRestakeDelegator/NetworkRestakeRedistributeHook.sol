...
} from "../../interfaces/networkRestakeDelegator/INetworkRestakeRedistributeHook.sol";
...
contract NetworkRestakeRedistributeHook is INetworkRestakeRedistributeHook {
    ...
    function onSlash(
        ...
        if (generalData.slasherType == 0) {
            ...
            slashableStake = INetworkRestakeDelegator(msg.sender)
                .stakeAt(subnetwork, operator, captureTimestamp, new bytes(0))
